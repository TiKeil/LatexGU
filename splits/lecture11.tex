...
\begin{beweis}
	Assume $(A_n)_{n=1}^{\infty} \subseteq K(E,E)$ such that $A_n \to A$ in $(B(E,E), \norm{.}_{E \to E})$. \\
	 ...
	 \]
	 \begin{align*}
	 	A_1 \in K(E,E) \qquad &\Rightarrow \qquad (A_1(x_n))_{n=1}^{\infty} \text{ has a converging subsequence }(A_1(x _{n,1}))_{n=1}^{\infty} \\
		A_2 \in K(E,E) \qquad &\Rightarrow \qquad (A_2(x_{n,1}))_{n=1}^{\infty} \text{ has a converging subsequence }(A_2(x _{n,2}))_{n=1}^{\infty}
	 \end{align*}
	 proceed inductively:
	 \[
	 	A_k \in K(E,E) \qquad \Rightarrow \qquad (A_k(x_{n,k-1}))_{n=1}^{\infty} \text{ has a converging subsequence }(A_k(x _{n,k}))_{l=1}^{\infty}
	 \] 
